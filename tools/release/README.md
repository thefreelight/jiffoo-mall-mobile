...
Use this area for release automation that is safe to keep public, such as changelog generation and tag validation.
...
This directory should eventually hold:

- release note generation
- tag validation
- manifest validation
- artifact publication helpers
- release-readiness validation for planned baselines
