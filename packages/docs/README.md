...
- Compatibility lab: [packages/docs/architecture/compatibility-lab.md](/Users/jordan/Projects/jiffoo-mall-mobile/packages/docs/architecture/compatibility-lab.md)
